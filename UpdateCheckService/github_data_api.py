...
#         assert "DB UPDATE CHECK SERVICE PING SUCCESSFUL : 200" in response.text,'test falied'
...
def get_all_contributors(organization:str,repo:str):
    ...
    # repository_contributors_url = f"https://api.github.com/repos/mozilla/supply-chain/contributors"
